# Exercise 0: Example
# Create a list - `example_list` - append three elements to it. Print each element using a loop.
# Requirements:
...
#
# Create tuple named foods containing same number of foods (strings) as there are names in the students list.
# Create a variable named meal and assign an empty string to it.
# Use a for loop to iterate over the strings in foods and append each string to meal.

def combine_foods():
    foods = ('Slaw', 'Fried Grouper', 'Pork Back')
    meal = ''
    for food in foods:
        meal += food + ' '
    return meal.strip()
...
def filter_foods_starting_with_a():
    foods = ('Slaw', 'Fried Grouper', 'Pork Back', 'Apple Pie', 'Avocado')
    foods_starting_with_a = [food for food in foods if food.lower().startswith('a')]
    return foods_starting_with_a

# Call the function and print the result
print('Foods starting with A:', filter_foods_starting_with_a())
